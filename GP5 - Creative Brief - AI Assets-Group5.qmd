...
![Sample gift box generated using ChatGPT](images/CPP Farmstore Gift Box-01.png)
...
![Sample Instagram Post Generated using ChatGPT](CPP Farmstore Gift Box Instagram Post.png)

# AI prompt documentation, if AI is used

## Sample Product Image Prompt Used:

Create a realistic, professional product photograph of a Cal Poly Pomona Farm Store gift box displayed on a rustic wooden table. The open gift box should be neatly arranged with locally made products, including jars of fruit preserves and jam, packaged nuts, candy, and a bottle of flavored dipping oil. Make each product clearly visible and attractively positioned, with realistic packaging and no distorted or unreadable labels.

Use bright natural lighting, warm earth tones, fresh greenery, and subtle green-and-gold accents inspired by Cal Poly Pomona. Add a few pieces of seasonal fruit around the box to reinforce the “Fresh from Our Farm to Your Campus” campaign theme. The overall mood should feel fresh, friendly, welcoming, authentic, and community-oriented rather than overly corporate or luxurious.

Use a clean background with a softly blurred farm or campus-inspired setting. Keep the gift box as the main focal point and leave some open space around the product for promotional text to be added later. Create the image in a polished commercial product-photography style suitable for an Instagram post and digital marketing campaign. Square 1:1 composition, high resolution, no people, no text, no logos, and no watermark.

For the product labels on the items, include the CPP Farmstore logo
...
## Instagram Post Prompt Used:

Create a polished, branded Instagram feed post promoting Cal Poly Pomona Farm Store gift boxes. Use a vertical 4:5 format, 1080 × 1350 pixels, optimized for viewing on a mobile phone.

Feature a realistic, professional product photograph of an open gift box displayed on a rustic wooden table. Arrange the box with locally made products, including fruit preserves, jam, packaged nuts, candy, and a bottle of flavored dipping oil. Make the products clearly visible and attractively arranged. Add seasonal citrus, fresh greenery, and subtle farm-inspired details around the box.

Use bright natural lighting, warm earth tones, natural greens, and CPP green-and-gold accents. Include a softly blurred farm, Farm Store, or Cal Poly Pomona campus setting in the background. The overall design should feel fresh, friendly, welcoming, authentic, student-friendly, and community-oriented rather than overly corporate or luxurious.

Use the uploaded circular **Cal Poly Pomona Farm Store logo** as the official branding element. Place it clearly near the top of the design without changing its colors, wording, proportions, or illustrated details. Use the same logo on the product labels where appropriate.

Include the following text in a clear visual hierarchy:

Give a Fresh Taste of CPP

Farm Store Gift Boxes

Starting at \$50

Shop Online or Visit the Farm Store

Add the campaign tagline near the bottom:

Fresh from Our Farm to Your Campus

Use clean, readable typography with strong contrast against the background. Leave enough spacing around each text element and avoid overcrowding the design. Keep the gift box as the main focal point, with promotional text positioned in open negative space. Create a cohesive, professional social media advertisement with no people, no watermark, use the CPP Farmstore additional logos, and no unrelated text.
